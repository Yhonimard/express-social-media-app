...
routes
   ...
   */
  .post(jwtVerify, upload.image.single("image"), celebrate(validation.createPost), controller.createPost);
...
routes
   ...
   *        description: something went wrong
   */
  .get(celebrate(validation.getAllPost), controller.getAllPost);
...
routes
   ...
   *        description: something went wrong
   */
  .patch(jwtVerify, celebrate(validation.updatePost), controller.updatePost);
...
routes
   ...
   *        description: something went wrong
   */
  .get(jwtVerify, celebrate(validation.getAllPostByCurrentUser), controller.getAllPostByCurrentUser);
...
routes
   ...
   *        description: something went wrong
   */
  .patch(jwtVerify, celebrate(validation.updatePostByUser), controller.updatePostByUser);
...
routes
   ...
   *        description: something went wrong
   */
  .delete(jwtVerify, celebrate(validation.deletePostByUser), controller.deletePostByUser);
...
routes
  ...
  .post(
    jwtVerify,
    celebrate(validation.createPostByUser),
...
routes
   ...
   *        description: something went wrong
   */
  .get(jwtVerify, celebrate(validation.getAllPostHasLikedCurrentUser), controller.getAllPostHasLikedCurrentUser);
...
routes.route(`/user/:uid/post`)
  /**
     ...
     *        description: something went wrong
     */
  .get(celebrate(validation.getPostByAuthorId), controller.getPostByAuthorId)
